...
def outputReportPage(pageName, allLinkCount, blockedLinkCount, blockRate, blockedLinkList):
    ...
    summary = '<div><b>总链接数量：</b>' + str(allLinkCount) + '</div><div><b>被屏蔽数量：</b>' + str(blockedLinkCount) + '，<b>被屏蔽比例：</b>' + str(blockRate) +  '</div><div><p><table class="hovertable">'
